...
import { useAuth } from '@/app/components/providers/DashboardAuthProvider';
...
const LoginPage: React.FC<LoginPageProps> = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            setIsLoading(true)
            setError('')
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/dashboard/login`, {
                email: email,
                password: password
            })
            ...
            localStorage.setItem('dashboard_user_email', userEmail)
